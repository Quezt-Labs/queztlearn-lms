          ...
          >
            <Alert className="border-amber-200 bg-amber-50 dark:bg-amber-950/20 dark:border-amber-900/50">
              ...
              <AlertDescription className="text-amber-800 dark:text-amber-200">
                ...
                <p className="text-sm">
                  This test series is being prepared. Enroll now to get notified
                  when tests are available and enjoy early access.
                </p>
              </AlertDescription>
            </Alert>
          </motion.div>
            ...
            <CardContent>
              {testSeries.description?.html ? (
                ...
                <div className="space-y-3 text-muted-foreground">
                  <p>
                    This comprehensive test series is designed to help you excel
                    in your exam preparation. Get access to carefully curated
                    tests that mirror the actual exam pattern and difficulty.
                  </p>
                  <p>
                    Each test includes detailed explanations, performance
                    analytics, and personalized feedback to help you identify
                      ...
                      <>
                        {testSeries.discountPercentage > 0 && (
                          <div className="space-y-2">
                            ...
                            <div className="text-xs text-muted-foreground">
                              {testSeries.discountPercentage}% discount applied
                            </div>
                          </div>
                        )}
                        <div className="space-y-2">
